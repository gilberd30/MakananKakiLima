...
//    fungsi untuk menambahkan user baru
    ...
    private fun validateRegisterDetails():Boolean{
        return when {
            ...
            TextUtils.isEmpty(et_password_confirm.text.toString().trim(){ it <= ' '})->{
                showErrorSnackBar(resources.getString(R.string.err_msg_enter_confirm_password),true)
                false
            }
            et_password.text.toString().trim(){ it <= ' '} != et_password_confirm.text.toString().trim(){ it <= ' '}->{
    ...
    private fun registerUser(){
        //mengecek data yang masuk dengan fungsi validate account
