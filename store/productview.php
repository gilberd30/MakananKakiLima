				...
				<div class="table-responsive">
					<?php
						...
						if (isset($_GET['id_del'])) {
							...
							$del = "DELETE FROM tbl_product WHERE id = '".$iddel."'";
							$img = "SELECT * FROM tbl_product WHERE id = '".$iddel."'";
					...
					<table class="table table-striped table-bordered table-hover" id="saya">
						...
						<tbody>
							<?php
								...
								$view = mysqli_query($conn, "SELECT * FROM tbl_product");
								...
								while ($rows = mysqli_fetch_array($view)) { ?>
									...
									<tr>
										...
										<td>
											<a href="edit-product.php?id=<?php echo $rows['id']?>">EDIT</a> | 
											<a href="?id_del=<?php echo $rows['id']?>" onclick="return confirm('Yakin kamu ingin menghapus Product?')">DELETE</a>
										</td>
									</tr>
